...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'input-field': 'block w-full mt-2 mb-1 border border-strongline rounded-lg p-3 bg-surface text-ink font-normal disabled:(bg-subtle text-muted)',
    primary: 'inline-flex items-center justify-center gap-2 rounded-lg bg-brand text-white px-4 py-2.5 font-medium hover:bg-brandhover transition-colors disabled:(opacity-60 cursor-wait)',
    secondary: 'inline-flex items-center justify-center gap-2 rounded-lg border border-line bg-surface px-3 py-2 font-medium hover:bg-hover transition-colors disabled:(opacity-60 cursor-wait)',
    card: 'bg-surface border border-line rounded-xl p-6',
    muted: 'text-muted',
